  ...
  if (reversing) {
    return (
      <div className="relative min-h-screen w-full overflow-hidden bg-black">
        <ReverseCamera fullscreen />
        {showGearHint && (
          <div className="fixed left-1/2 top-4 z-[500] -translate-x-1/2 rounded-full bg-black/65 px-3 py-1 text-[11px] font-semibold text-white backdrop-blur">
